...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    if (self.transitionMode == XTBubbleTransitionModePresent)
    {
        ...
        //evelyn 20170222
        [presentedControllerView setFrame:containerView.frame];
        ...
        self.bubble.transform = CGAffineTransformScale(CGAffineTransformIdentity, 0.001, 0.001);        self.bubble.backgroundColor = self.bubbleColor;
